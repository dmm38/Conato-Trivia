...
$(document).ready(function() {
    ...
    function showScore() {
        ...
        $('.image').attr('id', '15').attr('src', 'images/15.png'); 
        $('#score').show(1000);
        $('#done').click(function(){
            reset();
        });       
    ...
    function updateImage(imageId) {
        switch (imageId) {
            case '1': 
                ...
                break
            case '2': 
                $('.image').attr('id', '2').attr('src', 'images/2.png'); 
                break
            case '5': 
                $('.image').attr('id', '5').attr('src', 'images/5.png');
                break
            case '6': 
                $('.image').attr('id', '6').attr('src', 'images/6.png');
                break
            case '10': 
                $('.image').attr('id', '10').attr('src', 'images/10.png'); 
                break
            case '11': 
                $('.image').attr('id', '11').attr('src', 'images/11.png'); 
                break
            case '12': 
                $('.image').attr('id', '12').attr('src', 'images/12.png'); 
                break    
            case '13': 
                $('.image').attr('id', '13').attr('src', 'images/13.png'); 
                break  
            case '14': 
                $('.image').attr('id', '14').attr('src', 'images/14.png'); 
                break   
            case '4': 
                $('.image').attr('id', '4').attr('src', 'images/4.png'); 
                break  
            case '8': 
                $('.image').attr('id', '8').attr('src', 'images/8.png'); 
                break    
        }
    }
